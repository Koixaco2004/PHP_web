<?php $__env->startSection('title', 'Trang chủ - Website Tin Tức'); ?>
        ...
        <div class="relative" x-data="carousel()">
            <div class="overflow-hidden">
                <div class="flex transition-transform duration-500 ease-in-out" :style="`transform: translateX(-${currentSlide * 100}%)`">
                    <?php $__currentLoopData = $posts->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                                        ...
                                        <div class="lg:col-span-7 text-white z-10 pl-8">
                                            ...
                                            <h2 class="text-2xl lg:text-3xl font-bold mb-4 leading-tight">
                                                <?php echo e(Str::limit($post->title, 70)); ?>
                                            ...
                                            <div class="flex items-center space-x-4 mb-6 text-sm">
                                                <div class="flex items-center space-x-2">
                                                    <div class="w-7 h-7 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                                                        <span class="text-xs font-semibold text-white"><?php echo e(substr($post->user->name, 0, 1)); ?></span>
                                                    </div>
                                                    <span class="text-white text-opacity-90"><?php echo e($post->user->name); ?></span>
                                                </div>
                                            ...
                                            <a href="<?php echo e(route('posts.show', $post->slug)); ?>" class="inline-flex items-center px-6 py-3 bg-white text-primary-700 font-semibold rounded-lg hover:bg-primary-50 transition-all duration-200 transform hover:scale-105 shadow-lg">
                                                Đọc ngay
            ...
            <div class="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex space-x-2">
                <?php $__currentLoopData = $posts->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button @click="currentSlide = <?php echo e($index); ?>" 
                            ...
                            :class="currentSlide === <?php echo e($index); ?> ? 'bg-white' : 'bg-white bg-opacity-50'">
                    </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-0">
                        ...
                        <div class="md:col-span-2 p-6">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <span class="text-xs text-primary-500"><?php echo e($post->created_at->diffForHumans()); ?></span>
                            </div>
                            
                            <h2 class="text-lg font-semibold text-primary-900 mb-3 leading-tight">
                                <a href="<?php echo e(route('posts.show', $post->slug)); ?>" class="hover:text-primary-700">
                            ...
                            <?php if($post->excerpt): ?>
                                <p class="text-primary-600 mb-4 line-clamp-2 text-sm leading-relaxed"><?php echo e($post->excerpt); ?></p>
                            <?php endif; ?>
                            ...
                            <div class="flex items-center justify-between pt-3 border-t border-primary-100">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-sm text-primary-700"><?php echo e($post->user->name); ?></span>
                                </div>
                                <a href="<?php echo e(route('posts.show', $post->slug)); ?>" class="text-primary-600 hover:text-primary-900 text-sm font-medium">
                                    Đọc tiếp →
                                </a>
                            </div>
                        </div>
        ...
        <?php if($posts->hasPages()): ?>
            <div class="mt-8 flex justify-center">
                <nav class="flex items-center space-x-2">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($posts->previousPageUrl()); ?>" class="px-3 py-2 text-sm text-primary-600 hover:text-primary-900">← Trước</a>
                    <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $posts->getUrlRange(1, $posts->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($page == $posts->currentPage()): ?>
                            <span class="px-3 py-2 text-sm bg-primary-900 text-white rounded"><?php echo e($page); ?></span>
                        <?php else: ?>
                            <a href="<?php echo e($url); ?>" class="px-3 py-2 text-sm text-primary-600 hover:text-primary-900"><?php echo e($page); ?></a>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <?php if($posts->hasMorePages()): ?>
                        <a href="<?php echo e($posts->nextPageUrl()); ?>" class="px-3 py-2 text-sm text-primary-600 hover:text-primary-900">Tiếp →</a>
                    <?php else: ?>
    ...
    <div class="lg:col-span-1">
        ...
        <div class="bg-white rounded-lg border border-primary-200 p-6 mb-6">
            ...
            <div class="space-y-2">
                <?php $__currentLoopData = $navigationCategories->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
function carousel() {
    return {
        currentSlide: 0,
        totalSlides: <?php echo e($posts->take(5)->count()); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PHP\PHP_web\resources\views/home.blade.php ENDPATH**/ ?>