...
<nav class="flex items-center space-x-2 text-sm text-secondary-500 mb-6 animate-fade-in">
    <a href="<?php echo e(route('home')); ?>" class="hover:text-primary-600 transition-colors duration-200">Trang chủ</a>
    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
    </svg>
    <a href="<?php echo e(route('categories.show', $post->category)); ?>" class="hover:text-primary-600 transition-colors duration-200">
    ...
    <span class="text-secondary-700 font-medium truncate"><?php echo e($post->title); ?></span>
</nav>
    ...
    <div class="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <article class="bg-white rounded-xl shadow-sm border border-secondary-200 overflow-hidden mb-8 animate-slide-up">
            ...
            <div class="p-6 pb-0">
                ...
                <div class="flex items-center justify-between pb-6 border-b border-secondary-200">
                    <div class="flex items-center space-x-6">
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 bg-gradient-to-br from-primary-500 to-primary-600 rounded-full flex items-center justify-center">
                                <span class="text-white font-semibold"><?php echo e(substr($post->user->name, 0, 1)); ?></span>
                            </div>
                            <div>
                                <div class="font-medium text-secondary-900"><?php echo e($post->user->name); ?></div>
                        ...
                        <div class="hidden md:flex items-center space-x-4 text-sm text-secondary-500">
                            ...
                            <div class="flex items-center">
                                ...
                                <?php echo e($post->comments->where('is_approved', true)->count()); ?> bình luận
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-sm text-secondary-500 bg-secondary-50 px-3 py-1 rounded-full">
                        ...
                        <?php echo e(ceil(str_word_count(strip_tags($post->content)) / 200)); ?> phút đọc
                    </div>
                </div>
            </div>
            ...
            <?php if($post->main_image): ?>
                <div class="mb-6">
                    <img src="<?php echo e($post->main_image); ?>" 
            ...
            <div class="p-6">
                ...
                <!-- Post Images Gallery -->
                <?php if($post->images && $post->images->count() > 1): ?>
                    <div class="mb-8">
                        <h3 class="text-lg font-semibold text-secondary-900 mb-4">Hình ảnh bài viết</h3>
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <?php $__currentLoopData = $post->images->sortBy('sort_order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative group cursor-pointer" onclick="openImageModal('<?php echo e($image->image_url); ?>', '<?php echo e($image->alt_text ?? $post->title); ?>')">
                ...
                <div class="mt-8 pt-6 border-t border-secondary-200">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-secondary-500">
                            Bài viết được đăng lúc <?php echo e($post->created_at->format('H:i, d/m/Y')); ?>
            ...
            <div class="p-6">
                    ...
                    <div class="mb-8 p-6 bg-secondary-50 rounded-xl text-center">
                        <div class="flex flex-col items-center justify-center space-y-2">
                            ...
                            <p class="text-secondary-500 text-sm">
                                <a href="<?php echo e(route('login')); ?>" class="text-primary-600 hover:text-primary-700 font-medium">Đăng nhập</a> 
                                hoặc 
                                <a href="<?php echo e(route('register')); ?>" class="text-primary-600 hover:text-primary-700 font-medium">tạo tài khoản</a> 
                ...
                <div class="space-y-6">
                    <?php $__empty_1 = true; $__currentLoopData = $post->comments->whereNull('parent_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="comment-item animate-slide-up" style="animation-delay: <?php echo e($loop->index * 0.1); ?>s">
                            <div class="flex space-x-4">
                                <div class="flex-shrink-0">
                                    <div class="w-12 h-12 bg-gradient-to-br from-primary-500 to-primary-600 rounded-full flex items-center justify-center">
                                        <span class="text-white font-semibold text-lg"><?php echo e(substr($comment->user->name, 0, 1)); ?></span>
                                    </div>
                                </div>
                                <div class="flex-1 bg-secondary-50 rounded-xl p-4">
                                    <div class="flex items-center justify-between mb-2">
                                        <h5 class="font-semibold text-secondary-900"><?php echo e($comment->user->name); ?></h5>
                                        <time class="text-sm text-secondary-500"><?php echo e($comment->created_at->format('d/m/Y H:i')); ?></time>
                                    </div>
                                    <p class="text-secondary-700 mb-3"><?php echo e($comment->content); ?></p>
                                    ...
                                    <!-- Replies -->
                                    <?php if($comment->children->where('is_approved', true)->count() > 0): ?>
                                        <div class="mt-4 space-y-3">
                                            <?php $__currentLoopData = $comment->children->where('is_approved', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="flex space-x-3 ml-4">
                                                    <div class="flex-shrink-0">
                                                        <div class="w-8 h-8 bg-gradient-to-br from-secondary-500 to-secondary-600 rounded-full flex items-center justify-center">
                                                            <span class="text-white font-medium text-sm"><?php echo e(substr($reply->user->name, 0, 1)); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="flex-1 bg-white rounded-lg p-3 shadow-sm">
                                                        <div class="flex items-center justify-between mb-1">
                                                            <h6 class="font-medium text-secondary-900 text-sm"><?php echo e($reply->user->name); ?></h6>
                                                            <time class="text-xs text-secondary-500"><?php echo e($reply->created_at->format('d/m/Y H:i')); ?></time>
                                                        </div>
                                                        <p class="text-secondary-700 text-sm"><?php echo e($reply->content); ?></p>
                                                    </div>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $relatedPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <article class="bg-white rounded-lg border border-primary-200 hover:shadow-md transition-shadow duration-200 overflow-hidden">
                <?php if($relatedPost->main_image): ?>
                    <div class="h-48 overflow-hidden">
                        <img src="<?php echo e($relatedPost->main_image); ?>" alt="<?php echo e($relatedPost->title); ?>" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                <?php endif; ?>
                <div class="p-4">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-xs text-primary-500"><?php echo e($relatedPost->created_at->diffForHumans()); ?></span>
                    </div>
                    
                    <h4 class="text-lg font-semibold text-primary-900 mb-2 leading-tight">
                        <a href="<?php echo e(route('posts.show', $relatedPost->slug)); ?>" class="hover:text-primary-700">
                    ...
                    <?php if($relatedPost->excerpt): ?>
                        <p class="text-primary-600 mb-3 line-clamp-2 text-sm leading-relaxed"><?php echo e(Str::limit($relatedPost->excerpt, 100)); ?></p>
                    <?php endif; ?>
                    ...
                    <div class="flex items-center justify-between pt-2 border-t border-primary-100">
                        <div class="flex items-center space-x-2">
                            <div class="w-5 h-5 bg-primary-900 rounded-full flex items-center justify-center">
                                <span class="text-xs font-semibold text-white"><?php echo e(substr($relatedPost->user->name, 0, 1)); ?></span>
                            </div>
                            <span class="text-xs text-primary-700"><?php echo e($relatedPost->user->name); ?></span>
                        </div>
                        <a href="<?php echo e(route('posts.show', $relatedPost->slug)); ?>" class="text-primary-600 hover:text-primary-900 text-xs font-medium">
                            Đọc tiếp →
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PHP\PHP_web\resources\views/posts/show.blade.php ENDPATH**/ ?>