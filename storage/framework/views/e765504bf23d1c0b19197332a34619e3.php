...
<nav class="flex items-center space-x-2 text-sm text-secondary-500 mb-6 animate-fade-in">
    ...
    <span class="text-secondary-700 font-medium"><?php echo e($category->name); ?></span>
</nav>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-4">
                ...
                <div>
                    ...
                    <div class="flex items-center mt-2 text-secondary-600 space-x-4">
                        <div class="flex items-center">
                            ...
                            <?php echo e($posts->total()); ?> bài viết
                        </div>
                        <span>•</span>
                        <div class="flex items-center">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            Cập nhật <?php echo e($posts->count() > 0 ? $posts->first()->created_at->format('d/m/Y') : 'N/A'); ?>
            ...
            <div class="hidden md:flex items-center space-x-6">
                <div class="text-center">
                    <div class="text-2xl font-bold text-primary-600"><?php echo e($posts->total()); ?></div>
                    <div class="text-sm text-secondary-600">Bài viết</div>
                </div>
                <div class="text-center">
                    <div class="text-2xl font-bold text-accent-600"><?php echo e($posts->sum('view_count')); ?></div>
        ...
        <?php if($category->description): ?>
            <div class="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/50">
                <p class="text-secondary-700 leading-relaxed"><?php echo e($category->description); ?></p>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
    ...
    <div class="lg:col-span-8">
        ...
        <div class="space-y-6">
            <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article class="bg-white rounded-lg border border-primary-200 overflow-hidden p-6 hover:shadow-md transition-all duration-300 animate-slide-up group" style="animation-delay: <?php echo e($index * 0.1); ?>s">
                    <div class="flex space-x-6">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <?php if($post->excerpt): ?>
                                <p class="text-secondary-600 text-sm mb-4 line-clamp-2"><?php echo e($post->excerpt); ?></p>
                            <?php endif; ?>
                            
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    <div class="w-6 h-6 bg-primary-100 rounded-full flex items-center justify-center">
                                        <span class="text-xs font-medium text-primary-600"><?php echo e(substr($post->user->name, 0, 1)); ?></span>
                                    </div>
                                    <span class="text-sm text-secondary-600"><?php echo e($post->user->name); ?></span>
                                </div>
                                
                                <a href="<?php echo e(route('posts.show', $post->slug)); ?>" class="inline-flex items-center text-primary-600 hover:text-primary-700 font-medium text-sm transition-colors duration-200 group-hover:translate-x-1 transform">
                                    Đọc tiếp
        ...
        <?php if($posts->hasPages()): ?>
            <div class="mt-8 flex justify-center">
                <nav class="flex items-center space-x-2">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($posts->previousPageUrl()); ?>" class="px-4 py-2 text-sm text-secondary-600 bg-white border border-secondary-200 rounded-lg hover:bg-secondary-50 transition-colors duration-200">
                            ← Trước
                        </a>
                    <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $posts->getUrlRange(1, $posts->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($page == $posts->currentPage()): ?>
                            <span class="px-4 py-2 text-sm bg-primary-600 text-white rounded-lg"><?php echo e($page); ?></span>
                        <?php else: ?>
                            <a href="<?php echo e($url); ?>" class="px-4 py-2 text-sm text-secondary-600 bg-white border border-secondary-200 rounded-lg hover:bg-secondary-50 transition-colors duration-200"><?php echo e($page); ?></a>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    
                    <?php if($posts->hasMorePages()): ?>
                        <a href="<?php echo e($posts->nextPageUrl()); ?>" class="px-4 py-2 text-sm text-secondary-600 bg-white border border-secondary-200 rounded-lg hover:bg-secondary-50 transition-colors duration-200">
                            Tiếp →
                        </a>
                    <?php else: ?>
                        <span class="px-4 py-2 text-sm text-secondary-400 bg-secondary-100 rounded-lg cursor-not-allowed">
    ...
    <div class="lg:col-span-4 space-y-6">
        ...
        <div class="bg-white rounded-lg border border-primary-200 overflow-hidden hover:shadow-sm transition-all duration-200 animate-slide-up" style="animation-delay: 0.2s">
            ...
            <div class="p-6 space-y-4">
                <div class="flex items-center justify-between p-3 bg-primary-50 rounded-lg">
                    ...
                    <span class="text-2xl font-bold text-primary-600"><?php echo e($posts->total()); ?></span>
                </div>
                ...
                <div class="flex items-center justify-between p-3 bg-accent-50 rounded-lg">
                    ...
                    <span class="text-2xl font-bold text-accent-600"><?php echo e($posts->sum('view_count')); ?></span>
                </div>
                
                <?php if($category->description): ?>
                    <div class="p-4 bg-secondary-50 rounded-lg">
                        <h4 class="font-semibold text-secondary-900 mb-2">Mô tả</h4>
                        <p class="text-secondary-600 text-sm leading-relaxed"><?php echo e($category->description); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-primary-200 overflow-hidden hover:shadow-sm transition-all duration-200 animate-slide-up" style="animation-delay: 0.3s">
            ...
            <div class="p-6">
                <div class="space-y-2">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center justify-between p-3 rounded-lg hover:bg-secondary-50 transition-colors duration-200 group">
                        <div class="flex items-center">
                    ...
                    <a href="<?php echo e(route('home')); ?>#categories" class="flex items-center justify-between p-3 rounded-lg hover:bg-secondary-50 transition-colors duration-200 group">
                        <div class="flex items-center">
                            <svg class="w-4 h-4 text-secondary-400 group-hover:text-primary-500 mr-3 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                            </svg>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PHP\PHP_web\resources\views/categories/show.blade.php ENDPATH**/ ?>