...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
            <div class="relative">
                <!-- Cover Image -->
                <div class="h-48 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-t-lg"></div>
                                ...
                                @auth
                                    ...
                                    @else
                                        <div class="mt-4 sm:mt-0">
                                            <button class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition duration-150">
                                                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-medium text-gray-900">Bài viết của {{ $user->name }}</h2>
            </div>
            ...
            <div class="p-6">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500">{{ $user->name }} chưa đăng bài viết nào.</p>
                    </div>
                @endif
            </div>
        </div>
