        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Cập nhật thông tin cá nhân của bạn</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <h2 class="text-lg font-medium text-gray-900 mb-4">Ảnh đại diện</h2>
                    ...
                    <div class="flex flex-col items-center">
                        <div class="relative">
                            <div class="w-32 h-32 rounded-full overflow-hidden bg-gray-100 border-4 border-white shadow-lg">
                                ...
                                @else
                                    <div id="avatar-preview" class="w-full h-full flex items-center justify-center bg-gray-300">
                        ...
                        <form action="{{ route('profile.avatar') }}" method="POST" enctype="multipart/form-data" class="mt-4 w-full">
                            ...
                            <div class="flex flex-col space-y-3">
                                ...
                                <button type="button" onclick="document.getElementById('avatar-input').click()" 
                                        class="w-full px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition duration-150">
                                    Chọn ảnh mới
                                </button>
                                <button type="submit" id="upload-btn" class="w-full px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition duration-150 hidden">
                                    Tải lên
                                </button>
                            </div>
                            @error('avatar')
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST" class="p-6 space-y-6">
                        ...
                        <!-- Bio -->
                        <div>
                            <label for="bio" class="block text-sm font-medium text-gray-700 mb-2">Tiểu sử</label>
                            ...
                            <p class="text-sm text-gray-500 mt-1">Tối đa 500 ký tự</p>
                            @error('bio')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="border-t border-gray-200 pt-6">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Cài đặt quyền riêng tư</h3>
                            <div class="flex items-center">
                                ...
                                <label for="is_private" class="ml-3 text-sm font-medium text-gray-700">
                        ...
                        <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                            <a href="{{ route('profile.show') }}" 
                               class="px-6 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition duration-150">
                                Hủy bỏ
                            </a>
                            <button type="submit" 
