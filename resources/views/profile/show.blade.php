...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
            <div class="relative">
                <!-- Cover Image -->
                <div class="h-48 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-t-lg"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-semibold text-gray-900">{{ $user->posts->count() }}</p>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-semibold text-gray-900">{{ $user->role === 'admin' ? 'Admin' : 'User' }}</p>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="border-b border-gray-200">
                <nav class="-mb-px flex space-x-8 px-6" aria-label="Tabs">
                    <a href="#posts" class="tab-link border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm active">
                        Bài viết gần đây
                    </a>
                    <a href="{{ route('profile.activities') }}" class="tab-link border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                        Hoạt động
                    </a>
                </nav>
            </div>
            ...
            <div id="posts" class="p-6">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500 mb-4">Hãy bắt đầu chia sẻ những câu chuyện của bạn!</p>
                        <a href="{{ route('posts.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700">
