...
<div class="min-h-screen flex items-center justify-center px-4">
    <div class="max-w-4xl mx-auto text-center">
        ...
        <div class="relative mb-8">
            <div class="text-9xl font-bold text-yellow-200 select-none animate-pulse">403</div>
            <div class="absolute inset-0 flex items-center justify-center">
                <svg class="w-32 h-32 text-yellow-400 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Permission Info -->
        <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl p-6 mb-8 animate-slide-up" style="animation-delay: 0.4s">
            <div class="flex items-center justify-center mb-4">
                <svg class="w-8 h-8 text-yellow-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                </svg>
                <h2 class="text-2xl font-semibold text-yellow-900">Thông tin quyền truy cập</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white rounded-xl p-6 text-left">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-lg font-semibold text-red-900">Không được phép</h3>
                    </div>
                ...
                <div class="bg-white rounded-xl p-6 text-left">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-lg font-semibold text-green-900">Được phép</h3>
                    </div>
        ...
        <!-- Help Section -->
        <div class="bg-white rounded-2xl shadow-xl border border-secondary-200 p-8 mb-8 animate-slide-up" style="animation-delay: 0.8s">
            <div class="flex items-center justify-center mb-6">
                ...
                <h2 class="text-2xl font-semibold text-secondary-900">Cần trợ giúp?</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-secondary-900 mb-2">Tạo tài khoản</h3>
                    <p class="text-secondary-600 text-sm mb-4">Đăng ký để có thể truy cập nhiều nội dung hơn</p>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-secondary-900 mb-2">Liên hệ quản trị</h3>
                    <p class="text-secondary-600 text-sm mb-4">Yêu cầu cấp quyền truy cập từ quản trị viên</p>
                    <a href="mailto:admin@example.com" class="text-green-600 hover:text-green-700 font-medium text-sm">
                        Gửi email →
                    </a>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-secondary-900 mb-2">Xem hướng dẫn</h3>
                    <p class="text-secondary-600 text-sm mb-4">Tìm hiểu về phân quyền và cách sử dụng</p>
                    <a href="/help" class="text-purple-600 hover:text-purple-700 font-medium text-sm">
                        Xem hướng dẫn →
                    </a>
                </div>
            </div>
        ...
        <!-- Current User Info -->
        @auth
        <div class="bg-gradient-to-br from-secondary-50 to-secondary-100 rounded-xl p-6 animate-fade-in" style="animation-delay: 1s">
            <div class="flex items-center justify-center mb-3">
                <svg class="w-6 h-6 text-secondary-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                </svg>
                <h3 class="text-lg font-semibold text-secondary-900">Thông tin tài khoản hiện tại</h3>
            </div>
            <div class="text-center text-sm text-secondary-700">
                ...
                <p>Quyền hạn: <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-secondary-200 text-secondary-800">
