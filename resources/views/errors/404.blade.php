...
<div class="min-h-screen flex items-center justify-center px-4">
    <div class="max-w-4xl mx-auto text-center">
        ...
        <div class="relative mb-8 animate-bounce">
            <div class="text-9xl font-bold text-primary-200 select-none">404</div>
            <div class="absolute inset-0 flex items-center justify-center">
                <svg class="w-32 h-32 text-primary-400 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Search Section -->
        <div class="bg-white rounded-2xl shadow-xl border border-secondary-200 p-8 mb-12 animate-slide-up" style="animation-delay: 0.6s">
            <div class="flex items-center mb-6">
                <svg class="w-6 h-6 text-primary-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                </svg>
                <h2 class="text-2xl font-semibold text-secondary-900">Tìm kiếm nội dung</h2>
            </div>
            ...
            <form action="{{ route('search') ?? route('home') }}" method="GET" class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <div class="flex-1">
                    <input type="text" 
                           ...
                           class="w-full px-6 py-4 text-lg border border-secondary-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors duration-200">
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-slide-up" style="animation-delay: 0.8s">
            <div class="bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 class="text-lg font-semibold text-primary-900 mb-2">Bài viết mới nhất</h3>
                <p class="text-primary-700 text-sm mb-4">Khám phá những nội dung được cập nhật gần đây</p>
                <a href="{{ route('home') }}" class="text-primary-600 hover:text-primary-700 font-medium text-sm">
                    Xem ngay →
                </a>
            </div>

            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
                <div class="w-12 h-12 bg-green-500 rounded-lg flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
                    </svg>
                </div>
                <h3 class="text-lg font-semibold text-green-900 mb-2">Chuyên mục</h3>
                <p class="text-green-700 text-sm mb-4">Duyệt nội dung theo từng lĩnh vực cụ thể</p>
                <a href="{{ route('categories.index') ?? route('home') }}" class="text-green-600 hover:text-green-700 font-medium text-sm">
                    Khám phá →
                </a>
            </div>

            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
                <div class="w-12 h-12 bg-blue-500 rounded-lg flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                </div>
                <h3 class="text-lg font-semibold text-blue-900 mb-2">Trợ giúp</h3>
                <p class="text-blue-700 text-sm mb-4">Cần hỗ trợ? Liên hệ với chúng tôi</p>
                <a href="mailto:support@example.com" class="text-blue-600 hover:text-blue-700 font-medium text-sm">
                    Liên hệ →
                </a>
            </div>
        </div>
        ...
        <!-- Fun Message -->
        <div class="mt-12 p-6 bg-gradient-to-r from-accent-50 to-accent-100 rounded-xl animate-fade-in" style="animation-delay: 1s">
            <div class="flex items-center justify-center mb-3">
                ...
                <h3 class="text-lg font-semibold text-accent-900">Đừng buồn!</h3>
            </div>
            <p class="text-accent-700 text-sm max-w-md mx-auto">
