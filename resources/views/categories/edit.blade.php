...
<nav class="flex items-center space-x-2 text-sm text-secondary-500 mb-6 animate-fade-in">
    ...
    <span class="text-secondary-700 font-medium">Chỉnh sửa: {{ $category->name }}</span>
</nav>
...
<div class="bg-white rounded-xl shadow-sm border border-secondary-200 p-6 mb-8 animate-slide-up">
    <div class="flex items-center justify-between">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-3xl font-heading font-bold text-secondary-900">Chỉnh sửa chuyên mục</h1>
                <p class="text-secondary-600 mt-1">Cập nhật thông tin cho chuyên mục "{{ $category->name }}"</p>
            </div>
        </div>
        <div class="hidden md:flex items-center space-x-2 text-sm">
            <span class="px-3 py-1 bg-{{ $category->is_active ? 'green' : 'gray' }}-100 text-{{ $category->is_active ? 'green' : 'gray' }}-800 rounded-full font-medium">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-6 animate-slide-up" style="animation-delay: 0.5s">
                <div class="flex items-center mb-3">
                    ...
                    <h3 class="font-semibold text-primary-800">Thông tin chuyên mục</h3>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-secondary-200 p-6 animate-slide-up" style="animation-delay: 0.6s">
                ...
                <div class="border border-secondary-200 rounded-lg p-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <div class="font-medium text-secondary-900" id="preview-name">{{ $category->name }}</div>
                            <div class="text-sm text-secondary-500" id="preview-description">
