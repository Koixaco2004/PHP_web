...
<nav class="flex items-center space-x-2 text-sm text-secondary-500 mb-6 animate-fade-in">
    ...
    <a href="{{ route('categories.index') }}" class="hover:text-primary-600 transition-colors duration-200">Quản lý chuyên mục</a>
    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
    </svg>
    <span class="text-secondary-700 font-medium">Tạo chuyên mục mới</span>
</nav>
...
<div class="bg-white rounded-xl shadow-sm border border-secondary-200 p-6 mb-8 animate-slide-up">
    <div class="flex items-center">
        ...
        <div>
            <h1 class="text-3xl font-heading font-bold text-secondary-900">Tạo chuyên mục mới</h1>
            <p class="text-secondary-600 mt-1">Thêm chuyên mục mới để tổ chức nội dung website</p>
        </div>
    </div>
</div>
...
<div class="max-w-4xl mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form method="POST" action="{{ route('categories.store') }}" class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-secondary-200 p-6 animate-slide-up" style="animation-delay: 0.1s">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-lg font-semibold text-secondary-900">Thông tin cơ bản</h3>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" 
                                       class="block w-full px-4 py-3 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors duration-200 @error('name') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" 
                                       id="name" 
                                       name="name" 
                                       value="{{ old('name') }}" 
                            ...
                            @enderror
                            <p class="mt-1 text-xs text-secondary-500">Tên chuyên mục sẽ hiển thị cho người dùng</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-secondary-200 p-6 animate-slide-up" style="animation-delay: 0.2s">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-lg font-semibold text-secondary-900">Mô tả chuyên mục</h3>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <textarea class="block w-full px-4 py-3 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors duration-200 resize-none @error('description') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" 
                                      id="description" 
                                      name="description" 
                                      rows="4" 
                        ...
                        @enderror
                        <p class="mt-1 text-xs text-secondary-500">Mô tả sẽ giúp người dùng hiểu rõ hơn về nội dung chuyên mục</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-secondary-200 p-6 animate-slide-up" style="animation-delay: 0.3s">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-lg font-semibold text-secondary-900">Cài đặt</h3>
                    </div>
                    
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-4 bg-secondary-50 rounded-lg">
                            <div>
                                <h4 class="font-medium text-secondary-900">Trạng thái hoạt động</h4>
                                <p class="text-sm text-secondary-600">Chuyên mục sẽ hiển thị công khai trên website</p>
                            </div>
        ...
        <div class="lg:col-span-1 space-y-6">
            <!-- Tips -->
            <div class="bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-6 animate-slide-up" style="animation-delay: 0.5s">
                <div class="flex items-center mb-3">
                    <svg class="w-5 h-5 text-primary-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                    </svg>
                    <h3 class="font-semibold text-primary-800">Gợi ý</h3>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-secondary-200 p-6 animate-slide-up" style="animation-delay: 0.6s">
                <div class="flex items-center mb-3">
                    ...
                    <h3 class="font-semibold text-secondary-900">Xem trước</h3>
                </div>
                <div class="border border-secondary-200 rounded-lg p-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <div class="font-medium text-secondary-900" id="preview-name">Tên chuyên mục</div>
                            <div class="text-sm text-secondary-500" id="preview-description">Mô tả chuyên mục</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-secondary-200 p-6 animate-slide-up" style="animation-delay: 0.7s">
                <div class="flex items-center mb-3">
                    ...
                    <h3 class="font-semibold text-secondary-900">Chuyên mục gần đây</h3>
                </div>
                <div class="space-y-2 text-sm">
                    <div class="flex items-center justify-between p-2 hover:bg-secondary-50 rounded-lg transition-colors duration-200">
                        <span class="text-secondary-700">Tin tức</span>
                        <span class="text-secondary-500">5 bài viết</span>
                    </div>
                    <div class="flex items-center justify-between p-2 hover:bg-secondary-50 rounded-lg transition-colors duration-200">
                        <span class="text-secondary-700">Công nghệ</span>
                        <span class="text-secondary-500">12 bài viết</span>
                    </div>
                    <div class="flex items-center justify-between p-2 hover:bg-secondary-50 rounded-lg transition-colors duration-200">
                        <span class="text-secondary-700">Thể thao</span>
                        <span class="text-secondary-500">8 bài viết</span>
                    </div>
                </div>
            </div>
        </div>
