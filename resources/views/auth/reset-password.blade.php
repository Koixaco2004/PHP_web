...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-accent-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 animate-fade-in">
        ...
        <div class="text-center">
            ...
            <h2 class="mt-6 text-3xl font-heading font-bold text-secondary-900 dark:text-primary-100-dark">Đặt lại mật khẩu</h2>
            ...
            <form method="POST" action="{{ route('password.store') }}" class="space-y-6" id="resetForm">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" 
                               class="block w-full pl-10 pr-3 py-3 border border-secondary-300 dark:border-gray-600 rounded-lg bg-secondary-50 dark:bg-gray-700 text-secondary-600 dark:text-gray-300 cursor-not-allowed @error('email') border-red-500 dark:border-red-400 bg-red-50 dark:bg-red-900/20 @enderror" 
                               id="email" 
                               name="email" 
