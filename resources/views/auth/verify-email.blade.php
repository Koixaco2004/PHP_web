...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-accent-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <h2 class="mt-6 text-3xl font-heading font-bold text-secondary-900 dark:text-primary-400-dark">Xác thực Email</h2>
            <p class="mt-2 text-sm text-secondary-600 dark:text-gray-300">Vui lòng xác thực địa chỉ email của bạn để tiếp tục</p>
        </div>
