                                ...
                                @if($user->id !== Auth::user()->id)
                                    <form method="POST" action="{{ route('admin.users.destroy', $user) }}" class="inline">
                                        ...
                                        <button type="submit"
                                                ...
                                                onclick="event.preventDefault(); const form = this.closest('form'); showConfirmationModal('Xác nhận xóa', 'Bạn có chắc chắn muốn xóa người dùng này?', 'Xóa', () => { form.submit(); }); return false;">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
