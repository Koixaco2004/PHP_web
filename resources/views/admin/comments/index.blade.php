                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <form method="POST" action="{{ route('admin.comments.destroy', $comment) }}" class="inline">
                                    ...
                                    <button type="submit"
                                            ...
                                            title="Xóa bình luận"
                                            onclick="event.preventDefault(); const form = this.closest('form'); showConfirmationModal('Xác nhận xóa', 'Bạn có chắc chắn muốn xóa bình luận này?', 'Xóa', () => { form.submit(); }); return false;">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
